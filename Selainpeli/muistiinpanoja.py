#Lentokenttä olion tietorakenne:
...
game_data = {
    ...
    "message" : "Testiviesti",
    "name":f"{globaalit['name']}",
    "flight_type": f"{globaalit['flight_type']}",
    "destination": f"{globaalit['destination']}",
    ...
    "airports" : [  {"goal" : True , "visited":True, "icao":"efhk", "name": "helsinki", "country":"suomi", "lat": "50.22", "lon": "20.22", "gdp": "0"},
